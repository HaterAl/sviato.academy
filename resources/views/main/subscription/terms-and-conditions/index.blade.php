        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 normal-case">
                ...
                <p class="aos-init " data-aos="fade-up">
                    ...
                    Country refers to: Estonia<br>
                    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to OSPMU OÜ, Harju maakond, Tallinn, Lasnamäe linnaosa, Lasnamäe tn 4c-151, 11412.<br>
                    ...
                    Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Terms and Conditions Generator.<br>
                    ...
                    Website refers to Sviato Academy by Sviatoslav Otchenash, accessible from <a href="https://sviato.academy/">https://sviato.academy/</a><br>
                ...
                <p class="aos-init " data-aos="fade-up">
                    ...
                    Eligibility for each subscription plan is determined by the contract signed between the company and the consumer.<br>
                    The consumer is eligible for the Stylist plan only if they have signed the Stylist contract.<br> 
                    Similarly, eligibility for the Master plan requires a signed Master contract, and eligibility for the Trainer plan requires a signed Trainer contract.<br> 
                    Consumers who do not meet the eligibility criteria for any subscription plan will be issued a refund for any payments made and will be denied access to the subscription service.
                </p>
                ...
                Once subscribed, a recurring fee is charged on the same day each month for as long as the subscription lasts. 
                The subscriber can unsubscribe at any point. If there are not enough funds on the subscriber's card to cover the monthly fee, another attempt will be made on the following day.<br>
                Subscribers must ensure they have sufficient funds to cover the monthly fee.
            </p>
                <p class="aos-init " data-aos="fade-up">
                    <strong>Limitation of Liability</strong><br>
                    Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under any provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service or 100 EURO if You haven't purchased anything through the Service.<br>
                ...
                <p class="aos-init " data-aos="fade-up">
                    ...
                    By email: <a href="mailto:info@sviato.academy">info@sviato.academy</a>
                </p>
            </div>
