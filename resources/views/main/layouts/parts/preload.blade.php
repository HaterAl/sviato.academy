<link rel="preload" href="{{ Vite::fonts('BebasNeuePro-Bold.woff2') }}" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="{{ Vite::fonts('BebasNeuePro-BoldItalic.woff2') }}" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="{{ Vite::fonts('BebasNeuePro-Regular.woff2') }}" as="font" type="font/woff2" crossorigin>
